...
rman target / catalog rcuser/rcuser@orcl log=${LogFile}<<EOF
list backup summary;
list backupset;
run{
...
exit;
EOF
/opt/jdk1.7.0_03/bin/java -jar /home/oracle/mail.jar zhouguogong@qq.com guogongzhou@msn.cn DBBACKUP content ${LogFile}
echo "------------------------------end------------------------------"
